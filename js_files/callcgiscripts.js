...
if($("#rt").val()==""){
               		...
               		$("#output").html("कृपया प्रतीक्ष्यताम्....");
               		$.post("CGIURL/skt_gen/noun/noun_gen.cgi",{"rt":$("#rt").val(),"jAwi":$("#jAwi-opt").val(),"gen":$("#gen-opt").val(),"encoding":$("#encoding").val(),"level":$("#level").val()},function(data){
...
if($("#vb").val()==""){
               		...
               		$("#output").html("कृपया प्रतीक्ष्यताम्....");
               		$.post("CGIURL/skt_gen/verb/verb_gen.cgi",{"vb":$("#select").val(),"prayoga":$("#prayoga").val(),"upasarga":$("#upasarga").val(),"encoding":$("#encoding").val(),"paxI":$("#paxI").val()},function(data){
...
if($("#vb").val()==""){
               		...
               		$("#output").html("कृपया प्रतीक्ष्यताम्....");
               		$.post("CGIURL/skt_gen/kqw/kqw_gen.cgi",{"vb":$("#select").val(),"upasarga":$("#upasarga").val(),"encoding":$("#encoding").val()},function(data){
