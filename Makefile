...
config_server: 
	cd converters; ./configure
	cd transliteration; ./configure
	cd sandhi; ./configure
	cd skt_gen; ./configure
	cd skt_gen/compounds; ./configure
	cd htdocs; ./configure
	cd SHMT; ./configure
	cd ashtadhyayi_simulator; ./configure
	cd NN; ./configure; 
	cd amarakosha; ./configure
	cd dhaatupaatha; ./configure;
	cd e-readers/sankshepa_ramayanam; ./configure
	cd e-readers/shishu; ./configure
	cd e-readers/sbg; ./configure
	cd GOLD_DATA; ./configure
...
install:
	...
	mkdir -p HTDOCSDIR/e-readers
	cp -pr e-readers/sankshepa_ramayanam HTDOCSDIR/e-readers
	cp -pr dhaatupaatha HTDOCSDIR
	cp -r GOLD_DATA HTDOCSDIR/
	cp scl_help.pdf HTDOCSDIR
...
install_server:
	...
	cp -r e-readers/shishu HTDOCSDIR/e-readers
	cp -r e-readers/sankshepa_ramayanam HTDOCSDIR/e-readers
	cp -r dhaatupaatha HTDOCSDIR
	cp -r GOLD_DATA HTDOCSDIR/
	cp scl_help.pdf HTDOCSDIR
...
HTDOCS_SRC = htdocs/index.html htdocs/index_server.html htdocs/description.html htdocs/modelling-astadhyayi.html htdocs/projects.html htdocs/relevance-of-language-analysis.html htdocs/table.html htdocs/configure htdocs/Makefile htdocs/*.js htdocs/feedback.cgi htdocs/contributors.html css_files js_files imgs morph_bin htdocs/google*.html
...
SANDHI_SRC = sandhi/apavAxa_any.pl sandhi/README sandhi/web_interface/sandhi.cgi sandhi/web_interface/sandhi.html sandhi/any_sandhi.pl sandhi/test_sandhi.pl sandhi/Makefile sandhi/configure sandhi/Makefile.stage2 sandhi/sandhi.pl sandhi/web_interface/info.html 
...
AMARA_SRC = amarakosha/get_all_rel.pl amarakosha/callrel.pl amarakosha/configure amarakosha/Makefile amarakosha/web_interface/interface.cgi amarakosha/web_interface/index.html amarakosha/web_interface/frame.html amarakosha/web_interface/tail.html amarakosha/web_interface/banner.html amarakosha/web_interface/FAQ amarakosha/web_interface/contactUs.html amarakosha/web_interface/starting.html amarakosha/DBM/create_dbm.pl amarakosha/DBM/create_rule_onto.pl amarakosha/DBM/rules_onto amarakosha/DBM/all_kANdas amarakosha/DBM/Makefile amarakosha/DBM/create_onto_dbm.pl amarakosha/DBM/create_dbm_key_value.pl amarakosha/showMsg.pl amarakosha/relations.pl amarakosha/relations.sh amarakosha/shw_stem.pl amarakosha/Makefile.stage2 amarakosha/web_interface/about.html amarakosha/web_interface/amarakosha_knowledge_structure.pdf amarakosha/web_interface/logouoh.png amarakosha/amara.wx amarakosha/amara.utf8 amarakosha/web_interface/vESeRika_ontology.jpg

GEN_SRC = skt_gen/Makefile skt_gen/configure skt_gen/waxXiwa/noun_format_html.pl skt_gen/waxXiwa/gen_noun.pl skt_gen/waxXiwa/web_interface/waxXiwa_gen.html skt_gen/waxXiwa/web_interface/waxXiwa_gen.cgi skt_gen/waxXiwa/web_interface/noun_gen.cgi skt_gen/waxXiwa/waxXiwa_avy_html.pl skt_gen/waxXiwa/gen_waxXiwa.pl skt_gen/waxXiwa/waxXiwa_ind_html.pl skt_gen/waxXiwa/waxXiwa_format_html.pl skt_gen/waxXiwa/web_interface/waxXiwa.html skt_gen/noun/noun_format_html.pl skt_gen/noun/pUraNa.pl skt_gen/noun/saMKyeya.pl skt_gen/noun/saMKyA.pl skt_gen/noun/sarvanAma.pl skt_gen/noun/gen_noun.pl skt_gen/noun/web_interface/noun.html skt_gen/noun/web_interface/noun_gen.cgi skt_gen/verb/gen_verb.pl skt_gen/verb/verb_format_html.pl skt_gen/verb/web_interface/verb_gen.cgi skt_gen/verb/web_interface/verb.html skt_gen/kqw/web_interface/kqw.html skt_gen/kqw/web_interface/kqw_gen.html skt_gen/kqw/web_interface/kqw_gen.cgi skt_gen/kqw/kqw_avy_html.pl skt_gen/kqw/gen_kqw.pl skt_gen/kqw/kqw_format_html.pl skt_gen/Makefile.stage2 skt_gen/compounds

DATE = `date +"%d%b%Y"`

server_upload:
	tar -czf /tmp/a.tgz $(CONV_SRC) $(SANDHI_SRC) $(AMARA_SRC) $(HTDOCS_SRC) $(GEN_SRC) ashtadhyayi_simulator e-readers/sankshepa_ramayanam e-readers/shishu e-readers/sbg GOLD_DATA transliteration dhaatupaatha NN Makefile configure configure_server SPEC scl_help.pdf COPYING README START -T SHMT/MT_lst --exclude=_dit --exclude-backups --exclude=TRASH --exclude=OLD; mkdir /tmp/scl; cd /tmp/scl; tar -xzf /tmp/a.tgz; cd ../; tar -czf scl.tgz scl; rm a.tgz; rm -r /tmp/scl
	cp /tmp/scl.tgz scl_server$(DATE).tgz

distrib:
	tar -czf /tmp/a.tgz $(CONV_SRC) $(SANDHI_SRC) $(AMARA_SRC) $(HTDOCS_SRC) $(GEN_SRC) ashtadhyayi_simulator e-readers/sankshepa_ramayanam GOLD_DATA transliteration dhaatupaatha Makefile configure SPEC scl_help.pdf COPYING README START -T SHMT/MT_lst --exclude=_dit --exclude-backups --exclude=TRASH --exclude=OLD; mkdir /tmp/scl; cd /tmp/scl; tar -xzf /tmp/a.tgz; cd ../; tar -czf scl.tgz scl; rm a.tgz; rm -r /tmp/scl
