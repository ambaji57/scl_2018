...
$ANU_MT_PATH/wsd/cnvrtkaaraka2uniform_format.pl $TMP_FILES_PATH < $2
touch $TMP_FILES_PATH/wsd_files/bar.txt
$ANU_MT_PATH/wsd/wsd $ANU_MT_PATH/wsd/ < $TMP_FILES_PATH/wsd_files/rl1.clp > $TMP_FILES_PATH/wsd_files/bar.txt

cat $2 | $ANU_MT_PATH/wsd/create_wsd.pl $TMP_FILES_PATH/wsd_files/bar.txt > $3

paste $1 $3 | perl -p -e 's/^\t//'  > $TMP_FILES_PATH/tmpwsd
#mv $TMP_FILES_PATH/tmp $1
mv $TMP_FILES_PATH/tmpwsd $1
