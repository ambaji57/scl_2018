...
#use CGI::Carp qw(fatalsToBrowser);
	  ...
	  print "<div id=\"imgitems\" class=\"parsetrees\">\n<center>\n<ul id=\"trees\">\n"; 
          ...
          if(-e "HTDOCSDIR/SHMT/DEMO/$filename/$sentnum.dot") {
               system("GraphvizDot/dot -Tsvg -oHTDOCSDIR/SHMT/DEMO/$filename/$sentnum.svg HTDOCSDIR/SHMT/DEMO/$filename/$sentnum.dot");
               ...
               print "<img src=\"SCLURL/SHMT/DEMO/$filename/$sentnum.svg\" width=\"\" height=\"\" kddalt=\"graph showing all relations\"></li>\n";
          }
