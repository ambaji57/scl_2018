#SCLINSTALLDIR/SHMT/prog/reader_generator/convert_anvya.pl < $1_a.txt |\
#SCLINSTALLDIR/SHMT/prog/reader_generator/convert.pl < $1_a.txt > $1_a.html

SCLINSTALLDIR/SHMT/prog/reader_generator/convert.pl $2 < $1.txt > $1.html
