...
#$BIN_PATH/remove_prAtipadik_derivation_info.pl < TMPPATH5 > TMPPATH6
...
$BIN_PATH/remove_derivational_analysis_of_rUDa_kqws.pl $SHMT_PATH/prog/morph/rUDa_kqw.gdbm  |\
