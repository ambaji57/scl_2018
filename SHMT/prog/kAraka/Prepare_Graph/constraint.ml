(* Copyright: Amba Kulkarni (2014-2017)                             *)
    ...
    [ Relationc (to_id1,to_mid1,r1,from_id1,from_mid1) -> match m2 with
      [Relationc (to_id2,to_mid2,r2,from_id2,from_mid2) -> 
         ...
         (* With karwqsamAnAXikaraNa there can not be karma *)
                ...
                && (r2=8 && (r1 = 10 || r1 = 11 || r1 = 13))
         then False
         else if (from_id2 = from_id1) && (from_mid2 = from_mid1)
                && (r1=8 && (r2 = 10 || r2 = 11 || r2 = 13))
         then False
    ...
    [ Relationc (to_id1,to_mid1,r1,from_id1,from_mid1) -> match m2 with
      [Relationc (to_id2,to_mid2,r2,from_id2,from_mid2) -> 
         if from_id2=to_id1 && from_mid2=to_mid1
                && (r1=26 || r1 = 32) && r2=33 (* a RaRTI of a kriyAviSeRaNa or a viSeRaNa is not allowed *)
         then False
         else if from_id1=to_id2 && from_mid1=to_mid2
                && (r2=26 || r2 = 32) && r1=33 (* a RaRTI of a kriyAviSeRaNa or a viSeRaNa is not allowed *)
         then False
         else if from_id1=to_id2 && from_mid1=to_mid2
         ...
         then False
                ...
                && r2=35 && not (r1=7) (* aBexa with only karwA is allowed *)
         then False
         else if from_id1=to_id2 && from_mid1=to_mid2
                && r1=35 && not (r2=7) (* aBexa with only karwA is allowed *)
         then False
         else True
      ]
    ]
  ...
  | (*[ (i,Relationc (a1,b1,rel,a2,b2)) :: r ] ->*)
    [i :: r] ->  match List.nth rels (i-1) with
       [ Relationc (a1,b1,rel,a2,b2) -> let res = 
            ...
            else if rel=53 || rel=54 || rel=34 || rel=28 then rel * (a1-a2)
            else rel * (a1-a2) * 10 
   ...
   then 
        ...
        let dag2 = construct_dags (mid+1) final wrdb dags in  do {
            ...
            let dag4 = if ((inout_rels.(init+1) = 3 && init=mid)|| dag1 = [])
             ...
             then List.append dag1 dag4 else dag4 in do{
            (* print_string "dag1= "
            ; print_acc dag1
            ;print_newline()
            ;print_string "dag2= "
         ...
         where rec loop1 relations = fun
                          ...
                          | [Relationc (x,y,r,z,t)::rest1] -> 
                            if     (z=a && t=b && ((r=1 && r1=0) || (r1=97 && r=12) || (r1=53 && r=54) || (r1=53 && r=53)))
                                ...
                                || (x=c && y=d && r=24 && r1=8 )  (* karwqsamAnAXikaraNa and pUrvakAlaH *)
