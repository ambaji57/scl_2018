...
@vacanam = ("eka","xvi","bahu");
 ...
 $generator = "LTPROCBINDIR/lt-proc -ct $myPATH/morph_bin/sup_gen.bin";
 ...
 $str = "echo '".$LTPROC_IN."' | $generator | grep . | pr --columns=3 --across --omit-header | $myPATH/converters/ri_skt | $myPATH/converters/iscii2utf8.py 1 | $myPATH/skt_gen/noun/noun_format_html.pl $pUrvapaxa $rt_wx $lifga_wx";
 system($str);
}
