...
require "$myPATH/converters/convert.pl";
  ...
  $ltproc_cmd = "LTPROCBINDIR/lt-proc -ct $myPATH/morph_bin/kqw_gen.bin | pr --columns=3 --across --omit-header | $myPATH/converters/ri_skt | $myPATH/converters/iscii2utf8.py 1";
  $ltproc_cmd1 = "LTPROCBINDIR/lt-proc -ct $myPATH/morph_bin/kqw_gen.bin | $myPATH/converters/ri_skt | $myPATH/converters/iscii2utf8.py 1";

package main;
use CGI qw/:standard/;
#use CGI::Carp qw(fatalsToBrowser);
print "<script>\n";
print "function generate_noun_forms(encod,prAwi,lifga,jAwi,level){\n";
print "  window.open('CGIURL/skt_gen/noun/noun_gen.cgi?encoding='+encod+'&rt='+prAwi+'&gen='+lifga+'&jAwi='+jAwi+'&level='+level+'','popUpWindow','height=500,width=400,left=100,top=100,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes').focus();\n";
print "}\n";
...
$LTPROC_IN = "";
   ...
   print "<center>\n";
   print "$upasarga<a href=\"javascript:show('$rtutf8')\">$rtutf8<\/a>\n";
   print "<\/center>\n";
