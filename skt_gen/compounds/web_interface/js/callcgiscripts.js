   function samAsaprakAracgi() {
    ...
    $("#output6").html("");
    $("#output7").html("");
    $.post("CGIURL/skt_gen/compounds/samAsaprakAra.cgi",{encoding:$("#encoding").val(),vigraha:$("#vigraha_vAkya").val()},function(data,status){
       $("#output1").html(data)
    });
    return false;
   };
   function samasaprakaraexpertcgi() {
    ...
    $("#output6").html("");
    $("#output7").html("");
    $.post("CGIURL/skt_gen/compounds/samasaprakaraexpert.cgi",{input_encoding:$("#input_encoding").val(),output_encoding:$("#output_encoding").val(),pratipadika1:$("#pratipadika1").val(),pratyaya1:$("#pratyaya1").val(),pratipadika2:$("#pratipadika2").val(),pratyaya2:$("#pratyaya2").val(),viXAyakasUwra:$("#viXAyakasUwra").val()},function(data,status){
       $("#output1").html(data)
    });
    return false;
   };
