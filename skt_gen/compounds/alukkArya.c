...
sprintf(cmd,"/bin/echo \"^%s<vargaH:nA><lifgam:%s><viBakwiH:%d><vacanam:%d><level:1>$\" | LTPROCBINDIR/lt-proc -c -g %s/morph_bin/sup_gen.bin > %s",prawi,lifgam,viBakwiH,vacanam,myPATH,fout);
system(cmd);
